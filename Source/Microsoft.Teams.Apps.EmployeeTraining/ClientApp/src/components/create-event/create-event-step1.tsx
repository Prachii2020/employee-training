...
import Resources, { IConstantDropdownItem, ITimeZonesItem } from "../../constants/resources";
...
class CreateEventStep1 extends React.Component<ICreateEventsStep1Props, ICreateEventsStep1State> {
    ...
    constructor(props: any) {
        ...
        let date = new Date();
        this.teamId = "";
        let localTimeZone = new Date().toTimeString().substring(new Date().toTimeString().lastIndexOf("(") + 1, new Date().toTimeString().lastIndexOf(")"));
        let timeZoneName = Resources.windowsTimeZones.find((timeZone: ITimeZonesItem) => timeZone.id == localTimeZone)?.displayName;
        this.timeZone = timeZoneName ? timeZoneName : localTimeZone;
