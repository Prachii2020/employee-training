...
namespace Microsoft.Teams.Apps.EmployeeTraining.Tests.Helpers
{
    ...
    public class CategoryHelperTest
    {
        ...
        [TestMethod]
        public async Task ValidateCategoryInUse()
        {
            const string categoryToTest = "ad4b2b43-1cb5-408d-ab8a-17e28edac3ba";
            ...
            Assert.AreEqual(EventWorkflowHelperData.categoryList.Where(e => e.CategoryId == categoryToTest).FirstOrDefault().IsInUse, true);
        }
        ...
        public async Task ValidateCategoryInUse_NotInUse()
        {
            ...
            Assert.AreEqual(EventWorkflowHelperData.categoryList.Where(e => e.CategoryId == categoryToTest).FirstOrDefault().IsInUse, false);
        }
        ...
        public async Task BindCategoryDetailsAsync()
        {
            ...
            Assert.AreEqual(events[0].CategoryName != "", true);
