...
namespace Microsoft.Teams.Apps.EmployeeTraining.Test.Controllers
{
    ...
    public class EventControllerTest
    {
        ...
        public void EventControllerTestSetup()
        {
            ...
            eventController.ControllerContext.HttpContext = httpContext;
        }
        ...
        {
            this.userEventsHelper
                .Setup(u => u.RemoveEventAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .Returns(Task.FromResult(true));
        ...
        public async Task AllMethods_InvalidArguments_ReturnsBadRequest()
        {
            ...
            var getEventsAsyncInvalidSortByResult = (ObjectResult)await this.eventController.GetEventsAsync("random", 1, (int)EventSearchType.AllPublicPrivateEventsForUser, "random", "random", 2);
